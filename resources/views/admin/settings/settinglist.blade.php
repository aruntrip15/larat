                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('setting add',['id' => $setting->id ]) }}" type="button">
                                            <i class="material-icons">mode_edit</i>
                                        </a>
                                        @if(env('APP_ENV') != 'production')
                                        <a href="javascript:void(0)" data-href="{{ route('setting delete',['id' => $setting->id ]) }}" data-message="@lang('message.confirmDelete')" data-method="delete" type="button" class="deleteWithModal">
