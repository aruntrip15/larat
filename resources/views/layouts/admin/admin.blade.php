...
<body class="theme-{{globalSetting('adminTheme')}}">
    ...
    @include('layouts.admin.sidebars')    
    <!-- #Left and Right Side Bar -->
    ...
    @component('layouts.admin.deletemodal')
    @endcomponent
    <!-- Default Deleate Confirmation-->

    <!-- Default Bulk Action form -->
    @component('layouts.admin.bulkactionmodal')
    @endcomponent
    <!-- Default Bulk Action form -->
