...
<aside id="leftsidebar" class="sidebar">
    ...
    <div class="user-info clearfix">
        ...
        <!-- @endif -->
        <div class="image">
            <img src="{{ asset('images/user2.jpg') }}" width="48" height="48" alt="User" />
        </div>
    ...
    <div class="menu">
        <ul class="list">
            ...
            <li>
                <a href="javascript:void(0);" class="menu-toggle {{(Route::currentRouteName() == 'user list' ||  Route::currentRouteName() == 'user add' )? 'toggled' : '' }}">
                ...
                <ul class="ml-menu">
                    ...
                    <li class="{{(Route::currentRouteName()== 'user add')? 'active' : ''}}">
