<?php $__env->startSection('content'); ?>
    <div class="block-header">
        <h2><?php echo app('translator')->getFromJson('title.role'); ?> <a type="button"  href="<?php echo e(route('role add')); ?>" class="m-l-15 btn bg-<?php echo e(globalSetting('adminTheme')); ?> waves-effect"><i class="material-icons">add</i></a></h2>
    </div>
                        ...
                        <div class="row clearfix">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input class="form-control" placeholder="<?php echo app('translator')->getFromJson('label.roleName'); ?>" type="text" name="name" value="<?php echo e($searchFormData['name']); ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 button-demo">
                                ...
                                <a href="<?php echo e(route('role list')); ?>" type="button" class="btn btn-default waves-effect"><?php echo app('translator')->getFromJson('label.reset'); ?></a>
                            </div>
                        </div>
                    </form>
                </div>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('role add',['id' => $role->id ])); ?>" type="button">
                                            <i class="material-icons">mode_edit</i>
                                        </a>
                                        <a href="javascript:void(0)" data-href="<?php echo e(route('role delete',['id' => $role->id ])); ?>" data-message="<?php echo app('translator')->getFromJson('message.confirmDelete'); ?>" data-method="delete" type="button" class="deleteWithModal">
